...
import type { VariationChip } from '@backend/compose/compose';
import { createsFork, createsMateThreat, trapsPieces, winsTempo } from '@backend/concepts/detectors';
import { pinsCreatedEx, seeCapture } from '@backend/concepts/primitives';
import { positionalPurposes } from '@backend/concepts/positional';
import type { PositionalFact } from '@backend/concepts/positional';
import { composeComment } from '@backend/compose/compose';
import type { MoveReport } from '@backend/analysis/report';
